            ...
            <div class="col-lg-3 col-md-6">
                <div class="ftco-footer-widget">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{ url('/news') }}"><span class="fa fa-chevron-right mr-2"></span>News</a></li>
                        <li><a href="{{ url('/blog') }}"><span class="fa fa-chevron-right mr-2"></span>Blog</a></li>
                        <li><a href="{{ url('/forms') }}"><span class="fa fa-chevron-right mr-2"></span>Forms</a></li>
...
@media (max-width: 767.98px) {
    .psk-footer-legal { flex-direction: column; align-items: flex-start !important; gap: 8px; }
}
</style>
