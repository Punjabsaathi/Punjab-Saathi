...
class ServiceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $s = Service::create([
            ...
            'overview'         => '<p>Aadhaar Update service allows you to correct or update any inaccurate information on your Aadhaar card issued by UIDAI. Punjab Saathi helps you update your Aadhaar details quickly without standing in long queues at enrolment centres.</p>
...
<li>Children who need photo/biometric updates</li>
            ...
            'is_popular'       => true,
            'is_active'        => true,
            'meta_title'       => 'Aadhaar Update / Correction in Punjab | Punjab Saathi',
            'meta_description' => 'Correct name, address, DOB or mobile number on your Aadhaar card online. Punjab Saathi processes Aadhaar updates in 3–7 days. Serving all 22 districts of Punjab.',
...
<p>Punjab Saathi submits your income certificate application on the official Seva Kendra / SDM portal and tracks it until the certificate is issued and digitally signed.</p>',
            'processing_time'  => '3–7 Days',
            'fee_range'        => '₹99 – ₹149',
...
<li>Individuals requiring proof of annual income for legal or financial purposes</li>
            ...
            'is_popular'       => true,
            'is_active'        => true,
            'meta_title'       => 'Income Certificate Online Punjab | Punjab Saathi',
...
<li>Job applicants requiring category proof</li>
            ...
            'is_popular'       => true,
            'is_active'        => true,
            'meta_title'       => 'Caste Certificate Online Punjab — SC / ST / OBC / EWS | Punjab Saathi',
...
<li>Job applicants requiring state domicile proof</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Residence / Domicile Certificate Punjab | Punjab Saathi',
...
<li>Banks and financial institutions (with authorisation)</li>
            ...
            'is_popular'       => true,
            'is_active'        => true,
            'meta_title'       => 'Property Nakal / Fard Punjab — Land Records Online | Punjab Saathi',
...
<li>Court-ordered property transfer beneficiaries</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Property Mutation (Intkal) Application Punjab | Punjab Saathi',
...
<li>Passport/visa applicants requiring PCC</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Character Certificate / Police Clearance Punjab | Punjab Saathi',
...
<li>All age groups including children</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Disability Certificate / UDID Card Punjab | Punjab Saathi',
...
<li>Marriage must have taken place in Punjab or one spouse must be a Punjab resident</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Marriage Certificate Registration Punjab | Punjab Saathi',
...
<li>Shops and commercial establishments with at least one employee</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Shop & Establishment Registration Punjab | Punjab Saathi',
...
<li>Adults without a birth certificate seeking first-time registration</li>
            ...
            'is_popular'       => true,
            'is_active'        => true,
            'meta_title'       => 'Birth Certificate Registration Punjab | Punjab Saathi',
...
<li>Legal representative or authorised person</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Death Certificate Registration Punjab | Punjab Saathi',
...
<li>Residents of Punjab with a permanent address</li>
            ...
            'is_popular'       => true,
            'is_active'        => true,
            'meta_title'       => 'New Ration Card Apply Punjab | Punjab Saathi',
...
<li>Those who have moved and need address update</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Ration Card Update / Correction Punjab | Punjab Saathi',
...
<li>Applicant should not already have an LPG connection</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'LPG New Connection / PM Ujjwala Yojana Punjab | Punjab Saathi',
...
<li>Workers in construction, agriculture, domestic service, street vending, etc.</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'E-Shram Card Registration Punjab | Punjab Saathi',
...
<li>Voluntary registration for any business</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'GST Registration Punjab | Punjab Saathi',
...
<li>Persons who have changed their mobile number</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Mobile Number Aadhaar Link Punjab | Punjab Saathi',
...
<li>Excludes institutional landholders, government employees, income taxpayers above ₹2 lakh</li>
            ...
            'is_popular'       => true,
            'is_active'        => true,
            'meta_title'       => 'PM-KISAN Registration Punjab | Punjab Saathi',
...
<li>Eligibility is checked on the official PM-JAY portal</li>
            ...
            'is_popular'       => true,
            'is_active'        => true,
            'meta_title'       => 'Ayushman Bharat / PMJAY Card Punjab | Punjab Saathi',
        ...
        $s = Service::create([
            ...
            'overview'         => '<p>Punjab Saathi helps students fill and submit scholarship applications on the National Scholarship Portal (NSP) and Punjab scholarship portals. Scholarships are available for pre-matric (Class 1–10) and post-matric (Class 11 and above) students.</p>
...
<li>Enrolled in a recognised school or college in Punjab</li>
            ...
            'is_popular'       => true,
            'is_active'        => true,
            'meta_title'       => 'NSP Scholarship Form Filling Punjab | Punjab Saathi',
...
<li>Resident of Punjab</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Old Age Pension / Widow Pension Apply Punjab | Punjab Saathi',
...
<li>Aadhaar linked to bank account preferred</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'PMJJBY / PMSBY Insurance Enrolment Punjab | Punjab Saathi',
...
<li>Resident of Punjab</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'PM Awas Yojana Registration Punjab | Punjab Saathi',
        ...
        $s = Service::create([
            ...
            'overview'         => '<p>Stay updated with the latest Punjab government job vacancies. Punjab Saathi tracks all major Punjab government recruitment notifications and updates you as soon as new vacancies are announced.</p>
...
<li>Eligibility varies by recruitment; check individual notifications</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Punjab Government Job Alerts — PSSSB, Police, PSPCL | Punjab Saathi',
            'meta_description' => 'Get latest Punjab government job vacancy alerts — PSSSB, Punjab Police, PSPCL, Patwari, Clerk posts. Punjab Saathi tracks all major government recruitments.',
        ...
        $s = Service::create([
            ...
            'overview'         => '<p>A single mistake in a government job application form can lead to rejection or disqualification. Punjab Saathi\'s trained operators fill your online government job application form with precision — verifying eligibility, uploading documents in the correct format, and completing fee payment.</p>
...
<li>Must meet the eligibility criteria of the specific recruitment</li>
            ...
            'is_popular'       => true,
            'is_active'        => true,
            'meta_title'       => 'Government Job Form Filling Punjab — PSSSB, PPSC | Punjab Saathi',
        ...
        $s = Service::create([
            ...
            'overview'         => '<p>Admit card download can sometimes be tricky — portal errors, forgotten login details, or browser issues. Punjab Saathi helps you download your admit card quickly and correctly so you don\'t miss your exam.</p>',
            'processing_time'  => 'Same Day',
            'fee_range'        => '₹49 – ₹99',
...
<li>Admit card must have been released by the recruiting body</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Admit Card / Hall Ticket Download Punjab — PSSSB, PPSC | Punjab Saathi',
        ...
        $s = Service::create([
            ...
            'overview'         => '<p>Punjab Saathi assists students in filling online registration forms for Punjab university examinations, entrance tests, and college admissions. Common exams include PUCAT (Punjabi University Common Admission Test), GNAT, LLB entrance tests, and university semester registration forms.</p>',
            'processing_time'  => '1 Day',
            'fee_range'        => '₹99 – ₹199',
...
<li>Students registering for semester or annual exams</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'University / Entrance Exam Form Filling Punjab | Punjab Saathi',
        ...
        $s = Service::create([
            ...
            'overview'         => '<p>Punjab Saathi helps candidates check their Punjab government exam results, download answer keys, verify cut-off marks, and understand merit list calculations. We also guide candidates on how to file objections against incorrect answer keys.</p>',
            'processing_time'  => 'Same Day',
            'fee_range'        => '₹49 – ₹99',
...
<li>Result must have been declared by the recruiting body</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Punjab Govt Exam Result & Answer Key | Punjab Saathi',
        ...
        $s = Service::create([
            ...
            'overview'         => '<p>Many government exam portals and college forms require online fee payment, which can be difficult for those without a debit card, credit card, or net banking. Punjab Saathi accepts UPI and cash and makes the online payment on your behalf.</p>',
            'processing_time'  => 'Same Day',
            'fee_range'        => '₹49 – ₹99',
...
<li>Students, job applicants, or citizens paying government portal fees</li>
            ...
            'is_popular'       => false,
            'is_active'        => true,
            'meta_title'       => 'Online Fee Payment Assistance Punjab | Punjab Saathi',
